...
find . -iname '*.jpg' -exec mogrify -path ../images/ -bordercolor black -border 1x1 -fuzz 20% -trim +repage -gravity Center -crop 95%x95%+0+0 +repage '{}'  \;

popd  > /dev/null

echo
echo The dataset path is: $2/images
echo
